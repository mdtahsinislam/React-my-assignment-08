    ...
    return (
        <div className="navbar bg-base-100 shadow-sm">
            <div className="navbar-start">
                ...
                <Link to="/" className="btn btn-ghost text-xl rounded-l-full rounded-r-full">
                    <img className='w-3/12' src="./src/assets/logo.png" alt="" />Phudu
                </Link>
            </div>
            ...
            <div className="navbar-end mr-4">
                <button className="btn btn-primary rounded-l-full rounded-r-full">Emergency</button>
            </div>
        </div>
    );
};
