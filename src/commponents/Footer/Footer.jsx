...
const Footer = () => {
    return (
        ...
        <footer className="footer footer-horizontal footer-center  rounded p-10 bg-black text-white">
          <div> <a className="btn btn-ghost text-xl"><img className='w-3/12' src="./src/assets/logo.png" alt="" />Phudu</a></div>
...
{/* <Link to='/'> <><a className='link link-hover'>Home</a></></Link>
     <Link to='/about'> <><a className='link link-hover'>My Bookings</a></></Link>
     
    <Link to='/blog'>  <><a className='link link-hover'>Blogs</a></></Link>
